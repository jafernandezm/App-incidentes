            ...
            <div class="bg-white white:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('activo.scanWebsite') }}" method="post" class="flex items-center">
                        @csrf
                        <div>
                            <label for="domain name" class="block text-sm text-gray-900 dark:text-gray-950">Domain Name</label>
                            ...
                            <div class="flex items-center mt-2">
                                ...
                                <input type="text" name="url" placeholder="exmaple.bo" class="block w-full rounded-l-none rtl:rounded-l-lg rtl:rounded-r-none placeholder-gray-400/70 dark:placeholder-gray- rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 white:bg-gray-900 dark:text-gray-950 dark:focus:border-blue-300" />
